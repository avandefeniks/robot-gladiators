...
var fight = function() {
    // Alet players that they're starting the round
    window.alert("Welcome to Robot Gladiators!");

    // ask the player if they want to fight or skip the fight
    ...
    if (playerHealth <= 0) {
        ...
        window.alert(playerName + " stile has " + playerHealth +
        " health left.");
    }
    ...
    var confirmSkip = window.confirm("Are you sure you'd like to" +
    " quit?");
